...
import { Home, EdzoiOldal, Login, Register, Profil, SportKartyak, SportLeiras, EdzesNaplo, Logout, Klub, Terms,Ranglista,Esemenyek,Chat,Dashboard} from './assets/pages/routes';
