...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2025. Már 04. 08:45
...
(4, 2, 7, 'bela', 'feri', 'bferi Klubja', 'Vecsés', 'Hétfő', '16:28:00', NULL, 'halado'),
...
--
ALTER TABLE `klubbok`
  MODIFY `sprotklub_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
COMMIT;
