...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2025. Már 05. 09:06
...
ALTER TABLE `adatmodositas`
  ...
  ADD KEY `fr user_id_idx` (`user_id`);
...
ALTER TABLE `jelentkezes`
  ...
  ADD KEY `fk user_id_idx` (`user_id`),
  ADD KEY `fk sportklub_id_idx` (`sportkulb_id`);
...
ALTER TABLE `klubbok`
  ...
  ADD KEY `kb vnev_idx` (`vnev`),
  ADD KEY `kb knev_idx` (`knev`);
...
--
-- AUTO_INCREMENT a táblához `adatmodositas`
--
ALTER TABLE `adatmodositas`
  MODIFY `modositas_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `esemenyek`
  MODIFY `esemeny_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `klubbok`
  MODIFY `sprotklub_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `adatmodositas`
  ADD CONSTRAINT `fr user_id` FOREIGN KEY (`user_id`) REFERENCES `latogatok` (`user_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `jelentkezes`
  ADD CONSTRAINT `fk sportklub_id` FOREIGN KEY (`sportkulb_id`) REFERENCES `klubbok` (`sprotklub_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
--
ALTER TABLE `klubbok`
  ADD CONSTRAINT `fk user_id` FOREIGN KEY (`user_id`) REFERENCES `latogatok` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `kb knev` FOREIGN KEY (`knev`) REFERENCES `latogatok` (`knev`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `kb vnev` FOREIGN KEY (`vnev`) REFERENCES `latogatok` (`vnev`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Megkötések a táblához `sport`
--
ALTER TABLE `sport`
  ADD CONSTRAINT `sportid` FOREIGN KEY (`sport_id`) REFERENCES `klubbok` (`sport_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
